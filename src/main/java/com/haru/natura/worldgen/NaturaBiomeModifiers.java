...
public class NaturaBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        //        HolderSet.direct(placedFeatures.getOrThrow(NaturaPlacedFeatures.OVERWORLD_WOOD_PLACED_KEY)),
        //        GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_MAPLE_TREE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(Tags.Biomes.IS_PLAINS),
                HolderSet.direct(placedFeatures.getOrThrow(NaturaPlacedFeatures.MAPLE_TREE_PLACED_KEY)),
